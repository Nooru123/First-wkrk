                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      image: DecorationImage(
                          fit: BoxFit.fill,
                          image: NetworkImage("https://media.istockphoto.com/id/862117322/photo/poppy-fields-under-dramatic-skies.jpg?s=2048x2048&w=is&k=20&c=tfBLnLfTOQK0HwYZfP7YniuDZaiz24ZFMpYAiLc4k34=")
                      )
                  ),
                    ...
                    children: [
                      Padding(
                          ...
                          ShaderMask(
                            ...
                            child:Text("23°",style: TextStyle(fontSize: 130,color: Colors.white),),
                          )
                        ...
                        Row(
                          children: [
                            Padding(
                                ...
                                child:  Text("23⁰",style: TextStyle(fontSize: 40),)
                            ),Padding(
                                padding: const EdgeInsets.only(left: 30,),
                                child:  Text("16⁰",style: TextStyle(fontSize: 40),)
                            ),Padding(
